...
class BookListView(generics.ListAPIView):
    ...
    filter_backends = [filters.DjangoFilterBackend, SearchFilter, OrderingFilter] # integrate all filters
    ...
    # Enable ordering on these fields, and set a default ordering
